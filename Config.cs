...
public static class Config
{
    ...
    public static void Init()
    {
        ...
        GodMode = Category.CreateEntry("GodMode", false, "GodMode", "", false, true);
        //UnBreakableArmor = Category.CreateEntry("UnbreakableArmor", false, "Unbreakable Armor", "", false, true);
        IsInfStamina = Category.CreateEntry("InfStamina", false, "Infinite Stamina", "", false, true);
        IsNoHungry = Category.CreateEntry("NoHungry", false, "Never Hungry", "", false, true);
        IsNoDehydration = Category.CreateEntry("NoDehydration", false, "Never Thirsty", "", false, true);
        IsNoSleep = Category.CreateEntry("NoSleep", false, "Never Tired", "", false, true);
        IsNoFallDamage = Category.CreateEntry("NoFallDamage", false, "No Fall Damage", "", false, true);
        DamageMultiplier = Category.CreateEntry("MultiplierMenu", defaultMultiplierKey, "Damage Multiplier", "", false, true);
        DamageMultiplier.SetOptions(multiplierdict.Keys.ToArray());
        TimeMultiplier = Category.CreateEntry("TimeMultiplier", defaultMultiplierKey, "Time Speed Multiplier", "", false, true);
        TimeMultiplier.SetOptions(multiplierdict.Keys.ToArray());
        WalkSpeed = Category.CreateEntry("WalkSpeed", 2.6f, "WalkSpeed", "", false, true);
        WalkSpeed.SetRange(1f, 50f);
        RunSpeed = Category.CreateEntry("RunSpeed", 5.4f, "RunSpeed", "", false, true);
        RunSpeed.SetRange(1f, 50f);
        SwimSpeed = Category.CreateEntry("SwimSpeed", 3f, "SwimSpeed", "", false, true);
        SwimSpeed.SetRange(1f, 50f);
        StopTime = Category.CreateEntry("StopTime", false, "Stop Time", "", false, true);
        JumpMultiplier = Category.CreateEntry("JumpMultiplier", 0f, "Jump Multiplier", "", false, true);
        JumpMultiplier.SetRange(0f, 100f);
        IsInfiniteJumps = Category.CreateEntry("InfiniteJumps", false, "Infinite Jumps", "", false, true);
        IsMarioMode = Category.CreateEntry("MarioMode", false, "MarioMode", "", false, true);
        ShouldSaveSettings = Category.CreateEntry("SaveSettings", true, "Save Settings on load", "If enabled saving settings across saves will be persistent", false, true);
    }
    ...
    public static void UpdateSettings()
    {
        ...
        //ToggleFunctions.ArmourSystem.UnbreakableArmor(UnBreakableArmor.Value);
